...
const TokenStatusBar: FunctionComponent<Props> = ({ userId }) => {
  ...
  return (
    <TouchableOpacity
      onPress={() => router.push({ pathname: "/input_pages/ai/TokenShopScreen", params: { userId } })}
      style={{
    ...
    >
      ...
      <TSCaptionText textStyles={{ color: theme.palette.AWE_Green, marginTop: 6, textAlign: "right" }}>
        Tap to buy more →
      </TSCaptionText>
    </TouchableOpacity>
  );

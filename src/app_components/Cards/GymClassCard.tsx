...
const GymClassCard: FunctionComponent<GymClassCardProps> = (props) => {
  ...
  const handlePress = () => {
    router.push({ pathname: "/GymClassScreen", params: { ...props, private: String(props.private) } });
  };
...
export const GymClassTextCard: FunctionComponent<{
  ...
  const handlePress = () => {
    ...
    router.push({ pathname: "/GymClassScreen", params: { ...props.card, private: String(props.card.private) } });
  };
